 ...
 * 2. `[writable]` submem: {@link SubmemMetadata} 
...
export const mint = (args: MintArgs): TransactionInstruction => {
    ...
    const [submemPubkey] = pda.deriveSubmemMetadataPDA({
        mint: args.mint,
    }, _programId);
    ...
    return new TransactionInstruction({
        ...
        keys: [
            ...
            {pubkey: submemPubkey, isSigner: false, isWritable: true},
...
export const getSubmemMetadata = async (
    publicKey: PublicKey,
    commitmentOrConfig: Commitment | GetAccountInfoConfig | undefined = "processed"
): Promise<T.SubmemMetadata | undefined> => {
    ...
    return T.decodeSubmemMetadata(deserialize(T.SubmemMetadataSchema, buffer.data) as Record<string, unknown>);
}
