...
export interface SubmemMetadata {
  level: string;
  expiry: bigint;
...
export const decodeSubmemMetadata = (decoded: Decoded): SubmemMetadata => ({
    level: decoded["level"] as string,
...
export const SubmemMetadataSchema: Schema =  {
    struct: {
        level: "string",
        expiry: "u64",
