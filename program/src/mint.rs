...
pub fn mint(
	...
	submem: &mut AccountPDA<SubmemMetadata>,
	funding: &AccountInfo,
	...
	submem.data.level = level;
	submem.data.short_description = short_description;
	submem.data.expiry = expiry;
    submem.data.mint = *mint.info.key;
    submem.data.assoc_account = Some(*assoc_token_account.key);
